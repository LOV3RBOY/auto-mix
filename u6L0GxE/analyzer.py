...
def segment_audio(y, sr, num_segments=10):
    ...
    # Use a recurrence matrix for segmentation. k is the number of segments to find.
    # The librosa implementation can be sensitive; using a fallback if it fails.
    try:
        # Using a width for smoothing the recurrence matrix can improve results.
        # Add a margin to the chroma to prevent issues with silent sections.
    ...
    # Ensure boundaries start at 0 and end at the full duration
